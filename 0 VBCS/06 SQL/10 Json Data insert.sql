...
DECLARE
    ...
    PERSON_ID,
    json_object(
    'vaccination_type' value 'Second Dose',
    'vaccination_status' value SECOND_DOZE,
    'vaccination_date' value to_char(SECOND_DOZE_DATE, 'RRRR-MM-DD'),
    'vaccine_region' value REGION_CODE,
    'vaccination_reason' value NVL(REASON, '-')
    ) as ldata
    FROM fs_dm_covid_request_t
    where 
    SECOND_DOZE_UPDATE is null
...
INSERT INTO fs_request_details (
    request_id,
    object_version_num,
    request_number,
    request_type_id,
